...
class ObservationUrlsTests(SimpleTestCase):
    ...
    def test_observations_url_resolves(self):
        ...
        self.assertEqual(resolve('/api/v1/observations/').func.view_class, Observations)
    ...
    def test_observation_detail_url_resolves(self):
        ...
        self.assertEqual(resolve('/api/v1/observations/1/').func.view_class, ObservationDetail)
    ...
    def test_user_observations_url_resolves(self):
        ...
        self.assertEqual(resolve('/api/v1/observations/user/user-123').func.view_class, UserObservations)

    def test_observations_bulk_url_resolves(self):
        # Direct URL for the ObservationsBulk view
        self.assertEqual(resolve('/api/v1/observations/bulk/').func.view_class, ObservationsBulk)
